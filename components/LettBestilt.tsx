        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
          {highlights.map((item, i) => (
            <FadeIn key={item.title} delay={0.1 + i * 0.1}>
              <div className="bg-white rounded-3xl p-7 border border-[#1F2428]/[0.07] shadow-[0_18px_50px_rgba(31,36,40,0.06)] hover:shadow-[0_24px_70px_rgba(31,36,40,0.10)] hover:-translate-y-0.5 transition-all duration-200">
